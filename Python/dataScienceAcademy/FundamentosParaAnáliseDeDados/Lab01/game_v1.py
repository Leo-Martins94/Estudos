...
from tkinter import *
#impotando funções da biblioteca
import random
import time

#DEfinindo varivel para input da seleção de level
level = int(input("Qual nível você gostaria de jogar? 1/2/3/4/5 \n"))
#Definindo variavel para calculo da barra por level
length = 500/level
