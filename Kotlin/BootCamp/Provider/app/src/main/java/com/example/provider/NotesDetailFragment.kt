...
import com.example.provider.database.NoteDatabaseHelper.Companion.DESCRIPTION_NOTES
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    companion object {
        ...
        fun newInstance(id: Long): Companion {
            val bundle = Bundle()
            bundle.putLong(EXTRA_ID, id)

            val notesFragment: Companion = NotesDetailFragment
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): AlertDialog? {
        ...
        noteEditDescription = view?.findViewById(R.id.note_edit_descriptiom) as EditText
