...
import com.example.provider.database.NoteDatabaseHelper.Companion.TABLE_NOTES
import java.net.URL

class NotesProvider : ContentProvider() {

//metodo que inicia todo o Provider
...
//getType valida os dados vindos da url
    @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
...
//metodo query é o select do provider
    @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    override fun query(
...
//metodo update atualiza o id do provider
    @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    override fun update(
    ...
    companion object {
        const val AUTHORITY = "com.examples.provider.provider"
