...
class Aula23{
    static void Main(){
        ...
        //public inr GetLowerBound(dimensão);
        ...
        Console.WriteLine("O valor da possição 3 do vetor1 é {0}",valor0);
        Console.WriteLine("Vador da linha 1 coluna 3 da matriz é {0}",valor1);
        Console.WriteLine("------------------------------------------------");
        ...
        //public static void Sort(array); coloca o vetor em ordem crescente, para decresente basta usar o reverse
